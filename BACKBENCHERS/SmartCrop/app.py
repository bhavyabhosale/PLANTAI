...
st.set_page_config(page_title="BACKBENCHERS", page_icon="https://cdn.jsdelivr.net/gh/twitter/twemoji@master/assets/72x72/1f33f.png", layout='centered', initial_sidebar_state="collapsed")
...
def main():
    ...
    html_temp = """
    <div>
    <h1 style="color:MEDIUMSEAGREEN;text-align:center;"> BACKBENCHERS: Intelligent Crop Recommendation 🌱 </h1>
    </div>
    """
    ...
    with col:
        ...
        if st.button('Predict'):
            loaded_model = load_model('BACKBENCHERS\SmartCrop\model.pkl')
...
# Print the result
            col.success(f"{predicted_label} is recommended by the BACKBENCHERS for your farm.Thank You")
